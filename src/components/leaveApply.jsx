...
const LeaveApply = () => {
  ...
  return (
    <div className="bg-gray-20 flex min-h-screen w-full">
      {/* Left Sidebar */}
      <div className=" p-6 w-1/7 border-r flex flex-col">
      <div className="mt-[calc(20vh)]">
        <ul>
          <li
            onClick={() => handleCategoryChange('Leave')}
            className={`cursor-pointer px-2 py-2 ${
              activeCategory === 'Leave' ? 'text-blue-500 text-lg' : 'text-gray-500'
            }`}
          >
            Leave
          </li>
      ...
      <div className="bg-gray-20 w-6/7 p-6">
        ...
        {/* Form */}
        <div className="bg-gray-20 mx-auto w-full max-w-4xl justify-center relative left-[-20px]">
          <form
                          ...
                          <MenuItem key={index}>
                            {({ active }) => (
                              <button
                                type="button"
                                onClick={() =>
                                  handleSelectChange('leaveType', type)
                                }
                                className={`${
                                  active
                  ...
                  <div className="relative sm:col-span-6">
                    ...
                    >
                      ...
                      <ChevronUpIcon
                        ...
                        aria-hidden="true"
                        onClick={() =>
                          setApplyingDropdownOpen(!applyingDropdownOpen)
                        }
                      />
                    </label>
